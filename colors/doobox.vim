...
if !exists('g:doobox_bold')
  let g:doobox_bold=1
endif
if !exists('g:doobox_italic')
  if has('gui_running') || $TERM_ITALICS == 'true'
    let g:doobox_italic=1
  else
    let g:doobox_italic=0
  endif
endif
if !exists('g:doobox_undercurl')
  let g:doobox_undercurl=1
endif
if !exists('g:doobox_underline')
  let g:doobox_underline=1
endif
if !exists('g:doobox_inverse')
  let g:doobox_inverse=1
endif

if !exists('g:doobox_guisp_fallback') || index(['fg', 'bg'], g:doobox_guisp_fallback) == -1
  let g:doobox_guisp_fallback='NONE'
endif

if !exists('g:doobox_improved_strings')
  let g:doobox_improved_strings=0
endif

if !exists('g:doobox_improved_warnings')
  let g:doobox_improved_warnings=0
endif

if !exists('g:doobox_termcolors')
  let g:doobox_termcolors=256
endif

if !exists('g:doobox_invert_indent_guides')
  let g:doobox_invert_indent_guides=0
endif

if exists('g:doobox_contrast')
  echo 'g:doobox_contrast is deprecated; use g:doobox_contrast_light and g:doobox_contrast_dark instead'
endif

if !exists('g:doobox_contrast_dark')
  let g:doobox_contrast_dark='medium'
endif

if !exists('g:doobox_contrast_light')
  let g:doobox_contrast_light='medium'
endif
...
let s:gb.dark0       = ['#282828FF', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 236]     " 50-48-47
let s:gb.dark1       = ['#3c3836FF', 237]     " 60-56-54
let s:gb.dark2       = ['#504945FF', 239]     " 80-73-69
...
let s:italic = 'italic,'
if g:doobox_italic == 0
  let s:italic = ''
endif

let s:underline = 'underline,'
if g:doobox_underline == 0
  let s:underline = ''
endif

let s:undercurl = 'undercurl,'
if g:doobox_undercurl == 0
  let s:undercurl = ''
endif

let s:inverse = 'inverse,'
if g:doobox_inverse == 0
  let s:inverse = ''
endif
...
if s:is_dark
  ...
  if g:doobox_contrast_dark == 'soft'
    let s:bg0  = s:gb.dark0_soft
  elseif g:doobox_contrast_dark == 'hard'
  ...
  if g:doobox_contrast_light == 'soft'
    let s:bg0  = s:gb.light0_soft
  elseif g:doobox_contrast_light == 'hard'
...
if exists('g:doobox_hls_cursor')
  let s:hls_cursor = get(s:gb, g:doobox_hls_cursor)
endif

let s:number_column = s:none
if exists('g:doobox_number_column')
  let s:number_column = get(s:gb, g:doobox_number_column)
endif
...
if exists('g:gitgutter_override_sign_column_highlight') &&
  ...
  if exists('g:doobox_sign_column')
    let s:sign_column = get(s:gb, g:doobox_sign_column)
  endif
endif

let s:color_column = s:bg1
if exists('g:doobox_color_column')
  let s:color_column = get(s:gb, g:doobox_color_column)
endif

let s:vert_split = s:bg0
if exists('g:doobox_vert_split')
  let s:vert_split = get(s:gb, g:doobox_vert_split)
endif

let s:invert_signs = ''
if exists('g:doobox_invert_signs')
  if g:doobox_invert_signs == 1
    let s:invert_signs = s:inverse
  endif
endif

let s:invert_selection = s:inverse
if exists('g:doobox_invert_selection')
  if g:doobox_invert_selection == 0
    let s:invert_selection = ''
  endif
endif

let s:invert_tabline = ''
if exists('g:doobox_invert_tabline')
  if g:doobox_invert_tabline == 1
    let s:invert_tabline = s:inverse
  endif
endif

let s:italicize_comments = s:italic
if exists('g:doobox_italicize_comments')
  if g:doobox_italicize_comments == 0
    let s:italicize_comments = ''
  endif
endif

let s:italicize_strings = ''
if exists('g:doobox_italicize_strings')
  if g:doobox_italicize_strings == 1
...
function! s:HL(group, fg, ...)
  ...
  " special fallback
  if a:0 >= 3
    if g:doobox_guisp_fallback != 'NONE'
      let fg = a:3
    endif

    " bg fallback mode should invert higlighting
    if g:doobox_guisp_fallback == 'bg'
      let emstr .= 'inverse,'
    endif
  endif
...
" --- https://github.com/morhetz/doobox/issues/7
if s:is_dark
  set background=dark
else
...
if g:doobox_improved_strings == 0
...
if has("spell")
  ...
  if g:doobox_improved_warnings == 0
...
if g:indent_guides_auto_colors == 0
  if g:doobox_invert_indent_guides == 0
